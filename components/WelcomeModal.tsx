...
const WelcomeModal: React.FC<WelcomeModalProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-500">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] pointer-events-none overflow-visible">
            ...
            <div className="relative w-full max-w-5xl h-[650px] max-h-[90vh] bg-[#0d1117]/60 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_50px_100px_-20px_rgba(0,0,0,0.7)] flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                        <div className="relative mb-8 group">
                            ...
                            <img 
                                ...
                                alt="Kali Logo" 
                                className="w-32 h-32 relative z-10 drop-shadow-[0_0_15px_rgba(0,0,0,0.5)] transform group-hover:scale-105 transition-transform duration-500"
                            />
                        </div>
                        
                        <h2 className="text-2xl font-bold text-white mb-2 tracking-tight">KaliOS <span className="font-light text-gray-400">Web</span></h2>
                        <div className="text-[10px] font-mono text-gray-500 space-y-2 mt-6 border-t border-white/5 pt-6 w-full text-left">
                ...
                <div className="flex-1 flex flex-col relative bg-gradient-to-br from-white/5 to-transparent overflow-y-auto">
                    ...
                    <div className="flex-1 p-6 md:p-10 flex flex-col justify-center">
                        <div className="mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <h1 className="text-3xl md:text-4xl font-bold text-white mb-3 tracking-tight">System Initialization</h1>
                            <p className="text-base md:text-lg text-gray-400 font-light">Select your preferred operating environment.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full max-h-[400px]">
                            ...
                            <button 
                                ...
                                className="group relative flex flex-col h-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-cyan-500/50 rounded-2xl p-6 transition-all duration-300 text-left overflow-hidden shadow-lg hover:shadow-cyan-900/20 animate-in fade-in slide-in-from-bottom-4 duration-700"
                                style={{ animationDelay: '100ms' }}
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <div className="relative z-10 flex-1 flex flex-col">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-[0_0_15px_rgba(6,182,212,0.2)]">
                            ...
                            <button 
                                ...
                                className="group relative flex flex-col h-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-red-500/50 rounded-2xl p-6 transition-all duration-300 text-left overflow-hidden shadow-lg hover:shadow-red-900/20 animate-in fade-in slide-in-from-bottom-4 duration-700"
                                style={{ animationDelay: '200ms' }}
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                <div className="relative z-10 flex-1 flex flex-col">
                                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-red-500/20 to-orange-500/20 border border-white/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-[0_0_15px_rgba(239,68,68,0.2)]">
