                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar py-3 space-y-0.5 px-3">
                            {CATEGORIES.map((cat, idx) => (
                                <button
                                    ...
                                    className={`w-full text-left px-4 py-2.5 flex items-center gap-3 transition-all duration-200 rounded-lg border-l-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${activeCategory === cat.id
                    ...
                    <div className="flex-1 flex flex-col bg-transparent relative overflow-hidden">
                        ...
                        <div className={`h-14 md:h-16 border-t flex items-center justify-between px-4 md:px-6 shrink-0 ${isLightMode ? 'bg-slate-50/80 border-slate-200/50' : 'bg-black/20 border-white/5'}`}>
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${isLightMode
